...
public class Matrix {
	...
	public Matrix normalise() {
		for (int i=0; i<getNumRows(); i++) {
			for (int j=0; j<getNumCols(); j++) {
				...
				getData()[i][j] = Math
						.round(getData()[i][j] * 10000000000.0) / 10000000000.0;
			}
		}
		return this;
	}
	...
	/**
	 * Private static method that deals with the recursion of determinant calculation.
	 * Inspired by http://en.wikibooks.org/wiki/Algorithm_Implementation/Linear_Algebra/Determinant_of_a_Matrix
	 * @param data
	 * @return
	 */
